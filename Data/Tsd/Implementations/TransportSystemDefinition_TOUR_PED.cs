...
namespace TransportLinesManager.Data.Tsd
{
    ...
    {
        public static readonly TransportSystemDefinition TOUR_PED = new(
                    ItemClass.SubService.PublicTransportTours,
            VehicleInfo.VehicleType.None,
            TransportInfo.TransportType.Pedestrian,
            ItemClass.Level.Level5,
            [TransferManager.TransferReason.TouristA, TransferManager.TransferReason.TouristB, TransferManager.TransferReason.TouristC, TransferManager.TransferReason.TouristD],
