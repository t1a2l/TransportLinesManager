...
namespace TransportLinesManager.WorldInfoPanels.Components
{
    internal class TLMStudentTouristsReportLine : BaseReportLine<StudentsTouristsReport>
    {
        ...
        {
            m_students.localeID = "TLM_PASSENGER_REPORT_TITLE_STUDENT";
            m_tourists.localeID = "TLM_PASSENGER_REPORT_TITLE_TOURIST";
            m_total.localeID = "TLM_PASSENGER_REPORT_TITLE_TOTAL";
        ...
        {
            xAdvance += InitField(out m_students, "Student", "TLM_PASSENGER_REPORT_TITLE_STUDENT", xAdvance, TOTAL_DATA_COLUMNS_SPACE / 3);
            xAdvance += InitField(out m_tourists, "Tourist", "TLM_PASSENGER_REPORT_TITLE_TOURIST", xAdvance, TOTAL_DATA_COLUMNS_SPACE / 3);
            xAdvance += InitField(out m_total, "Tot", "TLM_PASSENGER_REPORT_TITLE_TOTAL", xAdvance, TOTAL_DATA_COLUMNS_SPACE / 3);
        }
