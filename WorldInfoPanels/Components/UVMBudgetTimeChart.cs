...
namespace TransportLinesManager.WorldInfoPanels.Components
{
    public class UVMBudgetTimeChart : TLMBaseTimeChart<UVMBudgetConfigTab, UVMBudgetTimeChart, UVMBudgetEditorLine, BudgetEntryXml>
    {
        ...
        public override void CreateLabels()
        {
            ...
            titleEffective.localeID = "TLM_EFFECTIVE_BUDGET_NOW";
            ...
            MonoUtils.CreateUIElement(out m_effectiveSprite, effectiveContainer.transform, "BarBg");
        ...
        public override string ClockTooltip { get; } = "TLM_BUDGET_CLOCK";
