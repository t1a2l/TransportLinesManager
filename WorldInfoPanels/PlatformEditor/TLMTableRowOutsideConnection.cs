...
namespace Klyte.TransportLinesManager.WorldInfoPanels.PlatformEditor
{
    public class TLMTableRowOutsideConnection : UICustomControl
    {
        ...
        private void ReloadData(ushort[] targetOutsideConnections)
        {
            ...
            TransportLinesManagerMod.Controller.BuildingLines.SafeGet(m_buildingId).GetPlatformData(m_platformIdx, out Data.Base.ConfigurationContainers.OutsideConnections.PlatformConfig dataObj);
